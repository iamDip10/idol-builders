  ...
  const content = {
    ...
    bn: {
      ...
      plotRules: {
        ...
        items: [
          'আইডল শ্রীন সিটি প্রকল্পের প্ল্টের আকার ৩, ৫, ১০ ও ২০ কাঠা।',
          ...
          'কিস্তিতে ক্ৱ্যটি ক্রয়ের ক্ষেত্রে প্লট মূল্যের অবশিষ্ট ৩৬, ৪৮, ৬০, ৭২, ৮৪, ৯৬ টির মধ্যে পরিশোধ করতে পারবেন।',
